...
data<-read.csv("wasting1.csv", header = T)
str(data)
...
t_tau_2 = t_tau
t_tau_2 = t_tau + (log(0.5877483)*2-mean(t_tau)) #child size at birth
...
##Export result##
fname= paste('realdata_wasting_nonpara_result', '_outcome.Rdata', sep = '')
...
load(file = paste('realdata_wasting_nonpara_result', '_outcome.Rdata', sep=''))
attach(object)
...
##Export result##
fname= paste('realdata_wasting_para_result', '_outcome.Rdata', sep = '')
object= list(n_samp=n_samp,
             ATE_bias_null=ATE_bias_null, ATE_bias_BART0=ATE_bias_BART0,
             ATE_bias_BART1=ATE_bias_BART1, ATE_bias_CF=ATE_bias_CF,
             ATE_bias_CB0=ATE_bias_CB0, #ATE_bias_CB1=ATE_bias_CB1, 
...
load(file = paste('realdata_wasting_para_result', '_outcome.Rdata', sep=''))
attach(object)
ATE<-data.frame(ATE_bias_BART0, ATE_bias_BART1, ATE_bias_CF, ATE_bias_CB0)
CATE<-data.frame(CATE_RMSE_BART0, CATE_RMSE_BART1, CATE_RMSE_CF, CATE_RMSE_CB0, CATE_RMSE_CT, CATE_RMSE_CTOT)
